...
public class LinkedInTechnicalIntCode {
    ...
    private static void assertCanPlaceFlowers(
        final int[] input,
    ...
    private static void assertTwoSumCorrectness(final TwoSum ts) {
    ...
    public static class MartysTwoSum implements TwoSum {
    ...
    public static class MartysSecondTwoSum implements TwoSum {
