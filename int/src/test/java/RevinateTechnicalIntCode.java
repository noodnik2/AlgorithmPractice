...
/**
 *  Revinate technical interview code: game of poker "full hand" detection
 */
class RevinateTechnicalIntCode {
    ...
    public void testCanDrawFullHouse() {
        ...
        Assertions.assertTrue(drawsToFullHouse(System.out) > 0);
    }
    ...
    public void testAverageFullHouseDraws() {
        ...
        for (int i = 0; i < 10; i++) {
            ...
            Assertions.assertTrue(nDraws > 0);
            nDrawsTotal += nDraws;
            nAttempts++;
        }
