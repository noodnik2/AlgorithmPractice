...
class FindMorphPath {
    ...
    static class OneCharMorpher {

        List<String> dictionary;

        // initialize with given dictionary of valid words
        OneCharMorpher(List<String> dictionary) {
    ...
    void tryCase(
        ...
        new OneCharMorpher(dictionary).find(target, List.of(seed), result);
